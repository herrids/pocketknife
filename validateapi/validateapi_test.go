...
func TestValidManifestReturnsClient(t *testing.T) {
	...
	if !strings.Contains(resp.Client, "Code generated by pocketknife") {
		t.Fatalf("client does not look like generated TypeScript: %q", resp.Client)
	}
...
func TestInvalidManifestReturnsErrors(t *testing.T) {
	...
	if resp.Client != "" {
		t.Fatalf("client must be empty on an invalid manifest, got %q", resp.Client)
	}
}
